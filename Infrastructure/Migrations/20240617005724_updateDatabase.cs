    ...
    public partial class updateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelatedBlogs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportToUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserReports_ReportCategories_ReportCategoryId",
                        column: x => x.ReportCategoryId,
                        principalTable: "ReportCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserReports_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelatedBlogs_BlogId",
                table: "RelatedBlogs",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReports_CreatedBy",
                table: "UserReports",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_UserReports_ProjectId",
                table: "UserReports",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReports_ReportCategoryId",
                table: "UserReports",
