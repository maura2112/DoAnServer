...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240818162302_isdeleted for bid")]
    partial class isdeletedforbid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AppUser", b =>
                {
                    ...
                    b.Property<int>("AmountBid")
                        .HasColumnType("int");

                    b.Property<int>("AmoutProject")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FavoriteProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.RateTransaction", b =>
                {
                    ...
                    b.Property<int>("User1IdRated")
                        .HasColumnType("int");

                    b.Property<int>("User2IdRated")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.UserReport", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.AppUser", "UserReported")
                        .WithMany()
